...
//##############################################################################
  ...
  while not Eof(txChipsName) and (iCount4 < iMAX) do
    begin
     // Inc(iCount4);
      Readln(txChipsName,arrChipsName[iCount4]);
      red1.Lines.Add(arrChipsName[iCount4]);
    end;
...
//##################################################################################
 // Readln(txChipsName,sChipsName,iCount4);

 // red1.Lines.Add(sChipsName);
